...
public class DefaultBuildableComponentIdResolveResult extends DefaultResourceAwareResolveResult implements BuildableComponentIdResolveResult {
    ...
    private VersionSelector acceptedVersionSelector;
    ...
    @Nullable
    @Override
    public VersionSelector getAcceptSelector() {
        return acceptedVersionSelector;
    }

    @Override
    public void setSelectors(VersionSelector preferredSelector, VersionSelector acceptSelector) {
        this.preferredVersionSelector = preferredSelector;
        this.acceptedVersionSelector = acceptSelector;
    }
}
